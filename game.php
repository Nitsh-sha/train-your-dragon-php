<?php 
  ...
  // if there is no requested id, redirect the user to the games page
  if(!isset($_GET['id'])) {
    ...
    $sql2 = "SELECT * FROM items WHERE items_category_id=2 ORDER BY RAND() LIMIT 3";
    $q2 = $conn->query($sql2);
            ...
            <div class="col-lg-4">
              <figure class="rounded p-3 bg-white shadow-sm" style="min-height: 367px;">
                ...
                <figcaption class="p-4 card-img-bottom">
                  ...
                  <a class="" href="game.php?id=<?php echo $row2->id; ?>" role="button">Learn about <?php echo $row2->name; ?></a>
                </figcaption>
              </figure>
            </div>
              <?php 
                ...
                <figure class="rounded p-3 bg-white shadow-sm" style="min-height: 367px;">
                 <!-- echo the image url -->
                  ...
                  <figcaption class="p-4 card-img-bottom">
                    ...
                    <a class="" href="drawing.php?id=<?php echo $row3->id; ?>" role="button">Learn about this drawing</a>
                  </figcaption>
                </figure>
              </div> 
            <?php 
